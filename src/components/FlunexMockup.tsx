...
const NODE_H = 46;
const center = (n: FlowNode) => ({ cx: n.x + n.w / 2, cy: n.y + NODE_H / 2 });
const rightAnchor = (n: FlowNode): Point => ({ x: n.x + n.w, y: n.y + NODE_H / 2 });
const leftAnchor = (n: FlowNode): Point => ({ x: n.x, y: n.y + NODE_H / 2 });
...
const byId = (id: string): FlowNode => nodes.find((n) => n.id === id)!;
const edges = [
