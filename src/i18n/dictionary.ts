...
export const dictionary = {
  pt: {
    ...
    recruiterFit: {
      ...
      heading: 'Combino com a sua vaga?',
      lead: 'Cole a descrição da vaga e a IA analisa, na hora, o quanto meu perfil encaixa — com honestidade.',
      placeholder: 'Cole aqui a descrição da vaga (responsabilidades, requisitos, stack)…',
      button: 'Analisar encaixe',
      analyzing: 'Analisando…',
      privacy: 'A vaga não é salva — vai só pra análise, com base só no meu perfil real.',
      scoreLabel: 'Encaixe',
      hint: 'A análise aparece aqui — score + por que combina, pontos de atenção e um pitch.',
      short: 'Cole uma descrição um pouco mais completa pra eu analisar direito.',
      error: 'Não rolou analisar agora. Tente de novo em instantes, ou me mande a vaga por email.',
    },
    contact: {
      eyebrow: 'Contato',
  ...
  en: {
    ...
    recruiterFit: {
      ...
      heading: 'Do I fit your role?',
      lead: 'Paste the job description and the AI analyzes, on the spot, how well my profile matches — honestly.',
      placeholder: 'Paste the job description here (responsibilities, requirements, stack)…',
      button: 'Analyze fit',
      analyzing: 'Analyzing…',
      privacy: 'The job post is not stored — it only goes to the analysis, based solely on my real profile.',
      scoreLabel: 'Fit',
      hint: 'The analysis shows up here — score + why it fits, watch-outs and a pitch.',
      short: 'Paste a slightly fuller description so I can analyze it properly.',
      error: "Couldn't analyze right now. Try again shortly, or email me the role.",
    },
    contact: {
      eyebrow: 'Contact',
