    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          Estou na busca de novas oportunidades como desenvolvedor front-end, entre em contato comigo para conversar.Será um prazer recebe-lo!
        </p>
