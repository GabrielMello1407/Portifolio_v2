...
- **Terminal interativo** — abre com `/` ou `⌘K` (e por um botão na navbar); aceita comandos (`help`, `projects`, `resume`, `gm`…).
- **Caça aos segredos** — easter eggs rastreados num medidor (Konami, "gm", troca de aba, terminal, `sudo`).
...
- Cada segredo encontrado aparece no medidor (canto inferior-esquerdo). Encontre os 5 🏆
